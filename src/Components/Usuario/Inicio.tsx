        ...
        <div className="parte-superior">
          ...
          {vistaActual === "registro" && (
            <div className="login-container">
              <div className="logo">
                <h1>Registro</h1>
                <p className="bienvenida-texto">Crea tu cuenta para acceder a SIRPROME</p>
              </div>
              <div className="form-group">
                <label htmlFor="nombre" className="label-mini">Nombre completo</label>
                <input
                  type="text"
                  id="nombre"
                  className="form-control mini-input"
              ...
              <div className="form-group">
                <label htmlFor="correo" className="label-mini">Correo electrónico</label>
                <input
                  type="email"
                  id="correo"
                  className="form-control mini-input"
              ...
              <div className="form-group">
                <label htmlFor="contraseña" className="label-mini">Contraseña</label>
                <input
                  type="password"
                  id="contraseña"
                  className="form-control mini-input"
              ...
              {mostrarExito && (
                <div className="mensaje-exito" style={{ display: "block" }}>
                  ...
                  <p>¡Registro exitoso! Bienvenido a SIRPROME.</p>
                </div>
              )}
            </div>
          )}
          ...
          {vistaActual === "recuperar" && (
            <div className="box-reset">
              <img
                ...
                src="data:image/svg+xml;base64,"
                alt="Escudo"
              />
              <div className="titulo-reset">Restablecer acceso</div>
              <div className="desc-reset">Introduce tu correo para recibir un enlace de recuperación.</div>
              <label htmlFor="correoRec" className="label-reset">Correo electrónico</label>
              <input
                type="email"
                id="correoRec"
              ...
              {mostrarExito && (
                <div className="msg-success">
                  ...
                  ¡Listo! Revisa tu correo para continuar el proceso.
                </div>
              )}
            </div>
          )}
          ...
          {vistaActual === "actualizarRol" && (
            <div className="rol-container">
              <h4 className="rol-title">Actualizar Rol</h4>
              <p className="user-id">ID Usuario: {idUsuario}</p>
              <div className="rol-options">
                <button
                  className={`rol-btn${rol === "estudiante" ? " selected" : ""}`}
                ...
                <button
                  className={`rol-btn${rol === "profesor" ? " selected" : ""}`}
